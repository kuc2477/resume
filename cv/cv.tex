...
\begin{rSection}{Research Interests}
	Differentiable Games, Variational Inequalities, Markov Games, Algorithmic Implicit Biases
\end{rSection}
...
\begin{rSection}{PUBLICATIONS}
	{\bf High-Probability Convergence Guarantees of Stochastic Gradient Descent Ascent in Structured Nonconvex Min-Max Games} \\
	{\bf Junsoo Ha} \\
	{\em Conference on Learning Theory (COLT), 2026}
...
\textit{Research Scientist} \hfill{\em Aug. 2021 - Aug. 2024}\\
{\small Built a flexible bespoke research framework that supports any existing financial markets}\\
{\small Built a highly parallelized, error-tolerant production inference system}\\
{\small Redesigned a data pipeline from scratch to support thousands of assets across the world}\\
{\small Developed a foundation model that could adapt to multiple financial markets}\\
{\small Raised code quality standards and introduced automated tests to make research reliable}
